...
if(window.innerWidth <= 800){
  document.querySelector('iframe').contentWindow.document.documentElement.style.height = '100%';
  document.querySelector('iframe').contentWindow.document.documentElement.style.width = '100%';
}